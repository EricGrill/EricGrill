...
> - [MCP Proxmox Admin](https://github.com/EricGrill/mcp-proxmox-admin) — Programmatic Proxmox control via API and SSH
...
<details>
<summary>Quick Start: Add these to your Claude config</summary>

...
heroImage: "/images/blog/claude-code-hooks-hero.png"
---
...
![When you look away for 30 seconds](/images/illustrations/claude-code-hooks/ai-chaos-triptych.png)

AI assistants are powerful. They're also enthusiastic. Sometimes too enthusiastic.

![Enthusiastic but needs supervision](/images/illustrations/claude-code-hooks/golden-retriever-coder.png)
